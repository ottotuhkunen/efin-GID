...
let fetch;
(async () => {
    const { default: fetchModule } = await _0b2‍.i('node-fetch');
    fetch = fetchModule;
...
app.get('/api/finland.kml', async (req, res) => {
    try {
        ...
        _0b2‍.g.console.error('Error fetching KML:', error);
...
app.get('/sigmet', async (req, res) => {
    try {
      ...
      _0b2‍.g.console.error('Error fetching SIGMET data:', error);
...
app.get('/flow', async (req, res) => {
    try {
      ...
      _0b2‍.g.console.error('Error fetching data:', error);
      res.status(500).send('Internal server error');
    }
});
...
app.get('/airport/:icao', async (req, res) => {
    ...
    try {
        ...
        _0b2‍.g.console.error("Error fetching airport data:", error);
...
app.get('/traffic', async (req, res) => {
  try {
      ...
      _0b2‍.g.console.error('Error fetching VATSIM data:', error);
